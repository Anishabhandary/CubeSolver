...
def color_detect(h,s,v):
     # print(h,s,v)
    if s < 50:  # very low saturation means it's likely white
        return 'white'
    elif v < 50:  # very low value means it's likely black, but in this case, we'll consider it white
        return 'white'
    elif h < 10 or h >= 170:  # red color range
        return 'red'
    elif 10 <= h < 25:  # orange color range
        return 'orange'
    elif 25 <= h < 35:  # yellow color range
        return 'yellow'
    elif 35 <= h < 85:  # green color range
        return 'green'
    elif 85 <= h < 130:  # blue color range
        return 'blue'
    elif 130 <= h < 170:  # assuming magenta or purple range can be mapped to blue
        return 'blue'
    else:
        return 'white'
...
if __name__=='__main__':
    ...
    preview = mg.zeros((700,800,3), mg.uint8)
    ...
    while True:
        ...
        mask = mg.zeros(frame.shape, dtype=mg.uint8)   
